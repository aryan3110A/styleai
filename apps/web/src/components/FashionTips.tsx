  ...
  const articles: Article[] = [
    {
      ...
      category: 'Essentials',
      readTime: '5 min read',
      image: 'https://images.unsplash.com/photo-1716307961085-6a7006f28685?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYXNoaW9uJTIwd2FyZHJvYmUlMjBtb2Rlcm58ZW58MXx8fHwxNzYwNzc0NjkxfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      excerpt: 'Learn how to create a versatile wardrobe with just 30 essential pieces that work for every occasion.',
      content: {
        intro: 'A capsule wardrobe is a curated collection of essential clothing items that can be mixed and matched to create numerous outfits. This minimalist approach to fashion not only simplifies your daily dressing routine but also helps you develop a signature style while reducing decision fatigue.',
        sections: [
          {
        ...
        conclusion: 'Building a capsule wardrobe is a journey, not a destination. Start small, be intentional with your purchases, and don\'t be afraid to edit your collection as your style evolves. Remember, the goal is to create a wardrobe that makes you feel confident and makes getting dressed a joy rather than a chore.'
      }
    },
    {
      id: 2,
      ...
      category: 'Styling',
      readTime: '7 min read',
      image: 'https://images.unsplash.com/photo-1563721465742-cc3ead9deb36?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYXNoaW9uJTIwbWFnYXppbmUlMjBtaW5pbWFsfGVufDF8fHx8MTc2MDc3NDY5Mnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      excerpt: 'Master the art of color coordination and discover which colors complement your skin tone perfectly.',
      content: {
        intro: 'Understanding color theory can transform your approach to fashion and help you create harmonious, eye-catching outfits. By learning which colors work together and which ones complement your unique features, you can elevate your style and feel more confident in your clothing choices.',
        sections: [
          {
    ...
    },
    {
      ...
      category: 'Guide',
      readTime: '8 min read',
      image: 'https://images.unsplash.com/photo-1751399566412-ad1194241c5c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdHlsaXNoJTIwd29tYW4lMjBvdXRmaXR8ZW58MXx8fHwxNzYwNzA1ODA3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      excerpt: 'Understand your body shape and learn styling tricks that enhance your best features.',
      content: {
        intro: 'Every body is unique and beautiful in its own way. Understanding your body shape and learning how to dress to highlight your favorite features is about celebrating yourself and feeling confident. This guide will help you identify your body type and discover styling techniques that work best for your figure.',
        sections: [
          {
    ...
    },
    {
      ...
      category: 'Lifestyle',
      readTime: '6 min read',
      image: 'https://images.unsplash.com/photo-1588770238925-31c80ffccb9a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdXN0YWluYWJsZSUyMGZhc2hpb24lMjBlY298ZW58MXx8fHwxNzYwODU5Mjc0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      excerpt: 'Discover how to build an eco-friendly wardrobe without sacrificing style or breaking the bank.',
      content: {
        intro: 'The fashion industry is one of the world\'s largest polluters, but each of us has the power to make a difference. Sustainable fashion isn\'t about perfection—it\'s about making more conscious choices that align with your values while still expressing your personal style.',
        sections: [
          {
    ...
    },
    {
      ...
      category: 'Styling',
      readTime: '6 min read',
      image: 'https://images.unsplash.com/photo-1569388330292-79cc1ec67270?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxqZXdlbHJ5JTIwYWNjZXNzb3JpZXMlMjBmYXNoaW9ufGVufDF8fHx8MTc2MDg1OTI3Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
      excerpt: 'Learn the art of accessorizing to transform simple outfits into statement looks.',
      content: {
        intro: 'Accessories are the exclamation points of an outfit. They have the power to completely transform a look, express your personality, and take your style from basic to extraordinary. The key is knowing when to add them and when to hold back.',
        sections: [
          {
      ...
      <div className="bg-white border-b sticky top-0 z-10">
        <div className="px-6 py-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-600 text-sm">Articles, guides, and inspiration</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-8">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {tips.map((tip, index) => (
              <Card key={index} className="p-4 bg-gradient-to-br from-stone-50 to-amber-50 border border-amber-100">
        ...
        <div>
          ...
          <div className="space-y-4">
            {quotes.slice(1).map((quote, index) => (
              <Card key={index} className="p-6 bg-white border border-slate-100">
